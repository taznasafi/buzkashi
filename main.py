...
erase_feature.outputGDBName = "subsidy_area"
...
erase_feature.erase_ineligible_from_coverage(LTE_env=path.join(path_links.input_bdb_base,
                                                               path_links.LTE_gdb),
                                             ineligible_env= path.join(path_links.input_bdb_base,
